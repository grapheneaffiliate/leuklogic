 ...
 *   head.html + <script type="module"> quote.mjs (import/export stripped) + app.js </script>
...
const engine = stripExports(readFileSync(join(tool, 'src/quote.mjs'), 'utf8'));

const html =
  head +
  '\n<script type="module">\n' +
  '/* ENGINE — inlined verbatim from src/quote.mjs\n' +
