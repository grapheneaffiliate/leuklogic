 ...
 *   head.html + <script type="module"> videocheck.mjs (import/export stripped) + app.js </script>
...
const engine = stripExports(readFileSync(join(tool, 'src/videocheck.mjs'), 'utf8'));

const html =
  head +
  '\n<script type="module">\n' +
  '/* ENGINE — inlined verbatim from src/videocheck.mjs\n' +
